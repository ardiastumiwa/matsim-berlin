...
public class ShapeAnalysis {
    ...
    private static final String shapeFile = "original-input-data/Bezirke_-_Berlin/Berlin_Bezirke.shp";
    //private static final String populationPath = "scenarios/berlin-v5.5-1pct/output-berlin-v5.5-1pct/berlin-v5.5-1pct.output_plans.xml.gz";
    //private static final String networkPath = "scenarios/berlin-v5.5-1pct/output-berlin-v5.5-1pct/berlin-v5.5-1pct.output_network.xml.gz";

    private static final String populationPath = "scenarios/berlin-v5.5-1pct/output-policy/berlin-v5.5-1pct.output_plans.xml.gz";
    private static final String networkPath = "scenarios/berlin-v5.5-1pct/output-policy/berlin-v5.5-1pct.output_network.xml.gz";
